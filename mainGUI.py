...
class App(ctk.CTk):
    def __init__(self):
        ...
        self.title("NHack Fracture Detector.AI")
        ...
        self.head_label = ctk.CTkLabel(master=self.head_frame, text="NHack Fracture Detector.AI",
        ...
        self.info_label = ctk.CTkLabel(master=self.main_frame,
                                       text="Bone fracture detection system, upload an x-ray image for fracture detection for Hand, Elbow or Shoulder.",
